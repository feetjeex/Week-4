 ...
 * com.example.mainactivity.Story.java
 * Madlibs
 *
 ...
 * A com.example.mainactivity.Story is Serializable, so it can be packed into an Intent as "extra" data.
 */
...
public class Story implements Serializable {
    ...
    /** constructs a new com.example.mainactivity.Story reading its text from the given input stream */
